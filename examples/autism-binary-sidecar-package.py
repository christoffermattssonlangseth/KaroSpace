...
FEATURE_MANIFEST_PATH = "autism-binary.features.json"
...
common_kwargs = dict(
    ...
    feature_sidecar_shard_size=10,
    neighbor_stats_annotations=[PRIMARY_ANNOTATION] + ADDITIONAL_ANNOTATIONS,
    neighbor_stats_permutations=0,
    neighbor_stats_seed=42,
    statistics_additional_annotations=[PRIMARY_ANNOTATION] + ADDITIONAL_ANNOTATIONS,
