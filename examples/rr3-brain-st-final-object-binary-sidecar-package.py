...
FEATURE_MANIFEST_PATH = "rr3-brain-st-final-object-binary.features.json"
...
common_kwargs = dict(
    ...
    marker_gene_annotations=["annot",
   'seurat_clusters', 'SCT_snn_res.0.5', 'annot', 'sample_condition', 'bio_origin','subgroups','annot_short'
    ],
    marker_genes_top_n=30,
    neighbor_stats_annotations=["annot",
  'seurat_clusters', 'SCT_snn_res.0.5', 'annot', 'sample_condition', 'bio_origin','subgroups','annot_short'
    ],
    neighbor_stats_permutations=0,
    neighbor_stats_seed=42,
    pseudobulk_de_annotations=["annot",
 'seurat_clusters', 'SCT_snn_res.0.5', 'annot', 'sample_condition', 'bio_origin','subgroups','annot_short'
    ],
