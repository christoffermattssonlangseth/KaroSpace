...
dataset = load_spatial_data(
    ...
    section_metadata=['age', 'sex', 'genotype', 'condition'],
...
export_to_html(
    ...
    main_cell_annotation="cell_class_updated",  # Initial annotation (categorical)
    title="KaroSpace",
    ...
    interaction_marker_annotations=["cell_class_updated"],
