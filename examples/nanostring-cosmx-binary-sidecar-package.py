...
PRIMARY_ANNOTATION = "Subclass_label"
...
FEATURE_MANIFEST_PATH = "nanostring-cosmx-binary.features.json"
...
common_kwargs = dict(
    ...
    marker_gene_annotations=[PRIMARY_ANNOTATION, "module_label", "Pathology"],
    marker_genes_top_n=30,
    neighbor_stats_annotations=[PRIMARY_ANNOTATION, "Pathology", "module_label"],
    neighbor_stats_permutations=0,
    neighbor_stats_seed=42,
    pseudobulk_de_annotations=[PRIMARY_ANNOTATION, "module_label"],
