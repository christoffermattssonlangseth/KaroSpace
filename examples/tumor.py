...
H5AD_PATH = '/Users/christoffer/work/spatialist/talbot_xenium/data/talbot_xenium_tumor_annotated-with-highly_variable_feature-subsetted-mana-neigh.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    main_cell_annotation="cytetype_annotation_leiden_4",  # Initial annotation (categorical)
    title="KaroSpace",
