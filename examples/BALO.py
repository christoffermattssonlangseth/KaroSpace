...
export_to_html(
    ...
    main_cell_annotation="leiden_2",  # Initial annotation (categorical)
    title="KaroSpace",
    ...
    #feature_manifest_path="BALO.features.json",  # optional; otherwise defaults to BALO.features.json
