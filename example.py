...
H5AD_PATH = '/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_cellcharter_neigh2_251219.h5ad'
...
export_to_html(
    ...
    additional_colors=[
       'anno_L3', 'anno_L2', 'anno_L1','leiden_3.5'
